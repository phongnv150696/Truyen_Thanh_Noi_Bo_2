  ...
  return (
    <div className="animate-fade-in" style={{ paddingBottom: '2rem' }}>
      <div style={{ marginBottom: '2.5rem' }}>
        <h1 style={{ fontSize: '2.2rem', fontWeight: 800, margin: 0 }}>Nhật ký Hoạt động</h1>
        <p style={{ color: '#94a3b8', fontSize: '1.1rem', marginTop: '0.4rem' }}>Theo dõi các thay đổi và truy vết tác vụ trong hệ thống.</p>
      </div>
