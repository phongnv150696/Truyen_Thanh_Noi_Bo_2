...
export default function AIReview({ user: _user, onLogout }: AIReviewProps) {
  ...
  return (
    <div className="ani-fade-in" style={{ width: '100%' }}>
      <div style={{ marginBottom: '2.5rem', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
        ...
        >
          <RefreshCw size={18} className={loading ? 'ani-spin' : ''} />
        ...
        {isReviewModalOpen && selectedNews && (
          ...
          >
            <motion.div 
              ...
              style={{ width: '100%', maxWidth: '800px', maxHeight: '90vh', overflowY: 'auto', border: '1px solid rgba(255,255,255,0.1)', padding: 0 }}
            >
                ...
                <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '1rem', borderTop: '1px solid rgba(255,255,255,0.05)', paddingTop: '2rem' }}>
                  ...
                  >
                    ...
                    <div style={{ display: 'flex', gap: '1rem' }}>
                      ...
                      >
                        {rejectingId === selectedNews.id ? <RefreshCw size={18} className="ani-spin" /> : <ThumbsDown size={18} />}
                        Từ chối
                      </button>
                      <button
                      ...
                      >
                        {approvingId === selectedNews.id ? <RefreshCw size={18} className="ani-spin" /> : <ThumbsUp size={18} />}
                        Phê chuẩn
                      </button>
                    </div>
                </div>
