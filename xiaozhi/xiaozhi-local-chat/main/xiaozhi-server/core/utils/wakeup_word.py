...
class WakeupWordsConfig:
    ...
    def _save_config(self, config: Dict):
        ...
        try:
            ...
            print(f"Lỗi không xác định khi lưu cấu hình: {e}")
            raise
    ...
    def update_wakeup_response(self, voice: str, file_path: str, text: str):
        ...
        try:
            ...
            print(f"Cập nhật cấu hình wake word thất bại: {e}")
            raise
        ...
        try:
            ...
            if os.path.exists(file_path):
                try:
                    ...
                    print(f"Xóa file audio đã tồn tại thất bại: {e}")
                    raise

            return file_path
        except Exception as e:
            print(f"Tạo đường dẫn file audio thất bại: {e}")
            raise